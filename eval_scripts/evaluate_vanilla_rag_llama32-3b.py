...
def load_eval_results(file_path: str="vanilla_rag_evaluation_results_llama32_2025oct_2_cleaned.json"):
    try:
        with open(file_path, 'r') as f:
            return json.load(f)
...
def append_to_json_file(result: dict, file_path: str="vanilla_rag_evaluation_results_llama32_2025oct_2_cleaned.json"):
    try:
...
if __name__ == "__main__":
    ...
    with open('vanilla_rag_evaluation_results_llama32_2025oct_2_cleaned.json', 'w') as f:
