...
decision_prompt = PromptTemplate.from_template(
    """Determine if the following question requires access to specific medical documents or detailed surgical information to be answered accurately.
...
Response:
<thinking> The question is asking for an explanation of suturing that was given earlier in the conversation. While the question does specify suturing, it is not asking about suturing but rather requesting to explain a previous response. </thinking>
<answer> no </answer>
...
DISCLAIMER: This app was not developed by the Vanderbilt University Medical Center. This app, the code, and the LLM
